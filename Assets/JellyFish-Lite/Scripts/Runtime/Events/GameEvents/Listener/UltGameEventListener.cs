...
{
    public class UltGameEventListener : MonoBehaviour, IEventListener
    {
        /// <summary>
        ...
        public async void OnEventRaisedRoutine(GameEvent raisedEvent)
        {
            if (ResponseDelay > 0f) await Await.Seconds(ResponseDelay);
            Response.Invoke();
